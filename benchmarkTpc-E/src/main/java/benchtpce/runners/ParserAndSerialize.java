...
/**
 * Created by carlosmorais on 10/03/2017.
 */
public class ParserAndSerialize {
    ...
    public static void main(String[] args) {
        ...
        path = System.getProperty("user.dir") + "/src/main/resources/files/serialized/testeMedium.dat";
        trace = parser.readXmlFile(System.getProperty("user.dir") + "/src/main/resources/files/original/testeMedium");
        trace.setFilename("testeMedium");
        ObjectSerializable.ObjectToFile(trace, path);
